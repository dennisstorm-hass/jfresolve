...
using Jellyfin.Plugin.Jfresolve;
using Microsoft.AspNetCore.Mvc;
using Microsoft.Extensions.Logging;

namespace Jellyfin.Plugin.Jfresolve.Api
{
    /// <summary>
    ...
    public class PluginApiController : ControllerBase
    {
        ...
        public async Task<IActionResult> PopulateLibraryAsync()
        {
            ...
            await Plugin.Instance.PopulateLibraryAsync().ConfigureAwait(false);
            ...
            [FromQuery] string? episode = null)
        {
            ...
            try
            {
                ...
                var manifestBase = config.AddonManifestUrl
                ...
                manifestBase = $"https://{manifestBase}";
